...
export function cartesianToArmAngles_Feed(w_offset: number, x: number, y: number, pre_x: number, pre_y: number, pre_a: number, pre_b: number, phi: number, rho: number): [number, number, number] {
    //cartesian to polar
